  ...
  void ti_profiler_start( BOOL enable )
  {
    ...
    {   
      TM_EnableTimer( PR_TIMER_NUM );
        ...
        IQ_InitLevel( C_INTH_TIMER1_IT, C_INTH_FIQ, 0, 1 );
      #else
        IQ_Unmask( IQ_TIM1 );
    ...
    else
    {
        ...
        IQ_InitLevel( C_INTH_TIMER1_IT, 0, 0, 1 );
      #else
        IQ_Mask( IQ_TIM1 );
      ...
      switch( msg->msg_id )
	   {
		 ...
		 case TI_NUC_MONITOR_START :
		 {
		   ...
		   if( ti_nuc_monitor_state == NUC_MONITOR_STOPPED )
		   {
			 ...
			 ti_nuc_monitor_current_buffer[ti_nuc_monitor_current_position++] = 0xAB;
			 ti_nuc_monitor_current_buffer[ti_nuc_monitor_current_position++] = 0xCD;
			 ti_nuc_monitor_current_buffer[ti_nuc_monitor_current_position++] = 0xEF;
			 ti_nuc_monitor_current_buffer[ti_nuc_monitor_current_position++] = 0x01;
