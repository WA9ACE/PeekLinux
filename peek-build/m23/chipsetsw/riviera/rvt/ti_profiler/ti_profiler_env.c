...
/*                                                                              */
/*    Purpose:         This function is used to notify the Riviera              */
...
ti_prf_get_info (T_RVM_INFO_SWE *p_info_swe)
{
   ...
   strncpy(p_info_swe->type_info.type4.swe_name, "TI_PRF", RVM_NAME_MAX_LEN);

   p_info_swe->type_info.type4.stack_pool_id = RVF_POOL_EXTERNAL_MEM;
   ...
   strncpy(p_info_swe->type_info.type4.mem_bank[0].bank_name, "TI_PRF", RVF_MAX_MB_LEN);
   p_info_swe->type_info.type4.mem_bank[0].initial_params.pool_id   = RVF_POOL_EXTERNAL_MEM;
