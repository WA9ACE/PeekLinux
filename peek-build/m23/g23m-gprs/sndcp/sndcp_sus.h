...
+----------------------------------------------------------------------------- 
|  Purpose :  Definitions for sndcp_sus.c 
+----------------------------------------------------------------------------- 
*/ 
...
/*---- HISTORY --------------------------------------------------------------*/
  ...
  $Log:: /GPRS/Condat/MS/SRC/SNDCP/sndcp_sus.h                             $
 * 
...
EXTERN void sig_cia_su_cia_comp_ind(T_CIA_COMP_IND* cia_comp_ind);

EXTERN void sig_mg_su_delete_pdus (UBYTE nsapi, UBYTE sapi);

EXTERN void sig_mg_su_n201 (UBYTE sapi, USHORT n201);

EXTERN void sig_mg_su_suspend (UBYTE sapi);

EXTERN void sig_mg_su_reset_ind (UBYTE sapi);

EXTERN void sig_mg_su_resume (UBYTE sapi);

EXTERN void sig_nu_su_unitdata_req (T_SN_UNITDATA_REQ* sn_unitdata_req,
                                    USHORT npdu_number,
                                    UBYTE nsapi,
                                    UBYTE sapi
                                    );
