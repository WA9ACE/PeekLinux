...
+----------------------------------------------------------------------------- 
|  Purpose :  Definitions for sndcp_suap.c 
+----------------------------------------------------------------------------- 
*/ 
...
/*---- HISTORY --------------------------------------------------------------*/
  ...
  $Log:: /GPRS/Condat/MS/SRC/SNDCP/sndcp_suap.h                            $
 * 
...
EXTERN void sua_ll_data_cnf ( T_LL_DATA_CNF *ll_data_cnf );



EXTERN void sua_ll_ready_ind ( T_LL_READY_IND *ll_ready_ind );
