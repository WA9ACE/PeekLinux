...
+----------------------------------------------------------------------------- 
|  Purpose :  Definitions for sndcp_nup.c 
+----------------------------------------------------------------------------- 
*/ 
...
/*---- HISTORY --------------------------------------------------------------*/
  ...
  $Log:: /GPRS/Condat/MS/SRC/SNDCP/sndcp_nup.h                             $
 * 
...
EXTERN void nu_sn_data_req ( T_SN_DATA_REQ *sn_data_req );

EXTERN void nu_sn_unitdata_req ( T_SN_UNITDATA_REQ *sn_unitdata_req );

EXTERN void nu_connection_state(UBYTE nsapi, BOOL opened);
