...
+----------------------------------------------------------------------------- 
|  Purpose :  Definitions for sndcp_mgs.c 
+----------------------------------------------------------------------------- 
*/ 
...
/*---- HISTORY --------------------------------------------------------------*/
  ...
  $Log:: /GPRS/Condat/MS/SRC/SNDCP/sndcp_mgs.h                             $
 * 
...
EXTERN void sig_sda_mg_re_est (UBYTE sapi, UBYTE nsapi);

EXTERN void sig_nd_mg_rec_no (UBYTE nsapi, UBYTE rec_no);
