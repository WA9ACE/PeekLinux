...
#define V24_HISR_STACK_SIZE (768) /* Bytes. */
#endif
...
#if ((BOARD == 8) || (BOARD == 9) || (BOARD == 40) || (BOARD == 41) || (CHIPSET == 12) || (CHIPSET == 15))
...
#elif ((CHIPSET == 7) || (CHIPSET == 8) || (CHIPSET == 9) || (CHIPSET == 10) || (CHIPSET == 11) || (CHIPSET == 12) || (CHIPSET == 14) || (CHIPSET == 15))
            /*
...
UAF_Init (T_fd_UartId uartNo)
{
    ...
    /*
      ...
      * IdleMode: 2, idle mode is never acknowledged i.e. not supported
      */
    //WRITE_UART_REGISTER(uart,SYSC,SYSC_SOFTRESET | SYSC_NOIDLEMODE);
...
//    WRITE_UART_REGISTER (uart, DLM, dlh[FD_BAUD_115200]);
    WRITE_UART_REGISTER (uart, DLL, 0x1A);
...
#else
	        WRITE_UART_REGISTER (
            uart, IER, READ_UART_REGISTER (uart, IER) | IER_SLEEP|ERBI | ETBEI | EDSSI);
#endif
                  ...
                  SYS_UWORD32 mask)
{
    ...
    if ((mask & (SYS_UWORD32)(1 << X)) &&
        (uart->flow_control_mode != fc_none)) {

        if (state & (SYS_UWORD32)(1 << X)) {
