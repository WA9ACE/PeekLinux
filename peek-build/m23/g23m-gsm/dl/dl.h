 ...
 * is´nt set: Disables the trace feature
 */
 ...
 * is´nt set: Enables buffered trace (write out in idle mode only)
 ...
 * is´nt set: Normal trace of measurement reports
 ...
 * is´nt set: Normal trace of empty frames
 */
 ...
 * is´nt set: No delayed release indication
 */
 ...
 * is´nt set: No delayed uplink of the SABM frame.
 */
#define DELAYED_SABM
 ...
 * is´nt set: In this case the dedicated mode is leaving immediately after
 ...
 * is´nt set: I frame must response with RR frame
 */
#define IFRAME_AS_RR
 ...
 * is´nt set: Primitves or traces are processed immediately even is DL within
