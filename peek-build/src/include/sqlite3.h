...
/*
** Get really useable size of dababase
*/
int sqlite3_GetDBSize(sqlite3 * db);

/*
** Set maximize size of dababase, its scope is from 1M to 5M by bytes
*/
void sqlite3_setdatabasemaxsize(int dbsize);

/*
** Judge whether need to delete records, it will return 1 if need to delete, otherwise is 0
*/
int sqlite3_IsDatabaseTooBig(sqlite3 * db);
