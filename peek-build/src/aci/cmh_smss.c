...
*/
extern void bal_printf( const char* fmt, ...);
...
#ifdef EMO_DEBUG
  bal_printf("CMW: return of concSMS %d\n", ret);
#endif
...
{
  NU_Sleep(200);
  TRACE_FUNCTION ("ANDREY: sAT_PlusCMGS ()");
...
#endif /* SIM_TOOLKIT */
#ifdef EMO_DEBUG
    bal_printf("CMW: got past simtoolkit..\n");
#endif
...
#ifdef EMO_DEBUG
    bal_printf("CMW: got past cmhSMS_codeMsg\n");
#endif
