...
/* RVM priority*/
#define		RVM_RVM_TASK_PRIORITY	(65)  //old 220 then 75
...
#define		RVM_TTY_TASK_PRIORITY			(237) //(238)
#define		RVM_AUDIO_TASK_PRIORITY		(69)	//(99)
...
#define		RVM_DAR_TASK_PRIORITY			(166) //(245)
...
#define		RVM_AS_TASK_PRIORITY			(RVM_AUDIO_TASK_PRIORITY)

#define		RVM_OBIGO_TASK_PRIORITY			(242)
#define		RVM_IMG_TASK_PRIORITY			(241)
#define     RVM_LCC_TASK_PRIORITY           (220)
