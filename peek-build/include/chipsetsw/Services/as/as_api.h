...
#define AS_VOLUME_LEVEL_1  1
#define AS_VOLUME_LEVEL_2  2
#define AS_VOLUME_LEVEL_3  3
#define AS_VOLUME_LEVEL_4  4
#define AS_VOLUME_LEVEL_5  5
#define AS_VOLUME_LEVEL_6  6
#define AS_VOLUME_LEVEL_7  7
#define AS_VOLUME_LEVEL_8  8
...
as_ringer_set_volume(T_AS_RINGER_MODE ringer_mode,
                     T_AS_VOLUME      volume);
///Get the volume for the given ringer mode                     
extern T_AS_RET
as_ringer_get_volume(T_AS_RINGER_MODE ringer_mode,
                     T_AS_VOLUME      *volume);                     
