...
| FILE    : m_rr_com.h                                                     |
| SOURCE  : "g23m-doc\doc\msg\rr_com.mdf"                                  |
...
typedef struct
{
  ...
  U8                        v_add_acc_tech_elem;      /*<  2:  1> valid-flag                                         */
  U8                        c_add_acc_tech_elem;      /*<  3:  1> counter                                            */
  T_add_acc_tech_elem       add_acc_tech_elem[MAX_ADD_RA_CAP]; /*<  4: 16> Additonal Access Technologies Element              */
} T_add_acc_tech;
#endif
...
{
// ELEM-FF: REL99 
  U8                        freq_scroll;              /*<  0:  1> Frequency Scrolling                                */
  U8                        bsic;                     /*<  1:  1> BSIC                                               */
...
typedef struct
{
  ...
  U8                        bsic;                     /*<  2:  1> BSIC                                               */
// ELEM-FF: REL99 
  U8                        rem_bsic;                 /*<  3:  1> Number Remaining BSIC                              */
  U8                        _align0;                  /*<  4:  1> alignment                                          */
  U8                        _align1;                  /*<  5:  1> alignment                                          */
  U8                        _align2;                  /*<  6:  1> alignment                                          */
  U8                        c_bsic_struct;            /*<  7:  1> counter                                            */
  T_bsic_struct             bsic_struct[MAX_BSIC];    /*<  8: 72> BSIC Structure                                     */
} T_gprs_bsic;
#endif
...
typedef struct
{
  U8                        dtm_g_high_ms_class;      /*<  0:  1> DTM GPRS High Multi Slot Sub-Class                 */
  U8                        offset_required;          /*<  1:  1> Offset required                                    */
  U8                        v_dtm_e_high_ms_class;    /*<  2:  1> valid-flag                                         */
  U8                        dtm_e_high_ms_class;      /*<  3:  1> DTM EGPRS High Multi Slot Sub-Class; only if the MS supports EGPRS DTM */
} T_dtm_high_ms;
#endif
...
// ELEM-FF: REL99 
  U8                        c_rep_priority;           /*<  1:  1> counter                                            */
  U8                        rep_priority[MAX_NNC];    /*<  2: 96> Reporting Priority                                 */
...
typedef struct
{
  U8                        t_gsm400_supp;            /*<  0:  1> T-GSM 400 Bands Supported                          */
  U8                        t_gsm400_cap;             /*<  1:  1> T-GSM 400 Associated Radio Capability              */
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
} T_t_gsm400_struct;
#endif
...
typedef struct
{
  ...
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
  T_rtds6                   rtds6;                    /*<  4: 12> Real Time Difference Structure 6 Bit               */
  U8                        _align2;                  /*< 16:  1> alignment                                          */
  U8                        _align3;                  /*< 17:  1> alignment                                          */
  U8                        v_rtds6_add;              /*< 18:  1> valid-flag                                         */
  U8                        c_rtds6_add;              /*< 19:  1> counter                                            */
  T_rtds6_add               rtds6_add[MAXRTDS6];      /*< 20:240> Real Time Difference Structure 6 Bit               */
} T_rtdd6;
#endif
...
typedef struct
{
  ...
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
  T_rtds12                  rtds12;                   /*<  4: 16> Real Time Difference Structure 12 Bit              */
  U8                        _align2;                  /*< 20:  1> alignment                                          */
  U8                        _align3;                  /*< 21:  1> alignment                                          */
  U8                        v_rtds12_add;             /*< 22:  1> valid-flag                                         */
  U8                        c_rtds12_add;             /*< 23:  1> counter                                            */
  T_rtds12_add              rtds12_add[MAXRTDS12];    /*< 24:160> Real Time Difference Structure 12 Bit              */
} T_rtdd12;
#endif
...
typedef struct
{
  ...
  U8                        v_rtdd6;                  /*<  3:  1> valid-flag                                         */
  T_rtdd6                   rtdd6;                    /*<  4:260> Real Time Difference Description 6 Bit             */
  U8                        _align3;                  /*<264:  1> alignment                                          */
  U8                        _align4;                  /*<265:  1> alignment                                          */
  U8                        _align5;                  /*<266:  1> alignment                                          */
  U8                        v_rtdd12;                 /*<267:  1> valid-flag                                         */
  T_rtdd12                  rtdd12;                   /*<268:184> Real Time Difference Description 12 Bit            */
} T_rtdd;
#endif
...
typedef struct
{
  ...
  U8                        th_rep_1900;              /*<  1:  1> 1900 reporting threshold                           */
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
} T_report_1900;
#endif
...
// ELEM-FF: REL99 
  ...
  U8                        ecsd_ms_class;            /*< 17:  1> ECSD Multi Slot Class                              */
// ELEM-FF: REL99 
  U8                        _align4;                  /*< 18:  1> alignment                                          */
  U8                        v_egprs_struct;           /*< 19:  1> valid-flag                                         */
  T_egprs_struct            egprs_struct;             /*< 20:  4> GPRS Multislot Class and Extended Dynamic Allocation Capability */
// ELEM-FF: REL99 
  U8                        _align5;                  /*< 24:  1> alignment                                          */
  U8                        _align6;                  /*< 25:  1> alignment                                          */
  U8                        _align7;                  /*< 26:  1> alignment                                          */
  U8                        v_dtm_struct;             /*< 27:  1> valid-flag                                         */
  T_dtm_struct              dtm_struct;               /*< 28:  4> DTM (E-)GPRS Multislot Sub-Class and MAC Mode Support */
} T_ms_struct;
#endif
...
typedef struct
{
  ...
  T_ms_struct               ms_struct;                /*< 20: 32> Multislot Capability Struct                        */
// ELEM-FF: REL99 
  U8                        v_pow_8psk_cap;           /*< 52:  1> valid-flag                                         */
  U8                        pow_8psk_cap;             /*< 53:  1> 8-PSK Power Capability                             */
// ELEM-FF: REL99 
  U8                        compact;                  /*< 54:  1> COMPACT Interference Measurement Capability; COMPACT Interference Measurement Capability is implemented (1) or not (0) */
// ELEM-FF: REL99 
  U8                        rev99;                    /*< 55:  1> Revision Level                                     */
// ELEM-FF: REL99 
...
//   U8                        _align1;                  /*<  2:  1> alignment                                          */
//   U8                        _align2;                  /*<  3:  1> alignment                                          */
//   T_acc_cap                 acc_cap;                  /*<  4: 60> Access capabilities                                */
// } T_ra_cap2;
// #endif
// 
...
typedef struct
{
  ...
  T_acc_cap                 acc_cap;                  /*<  4: 60> Access capabilities                                */
  U8                        _align2;                  /*< 64:  1> alignment                                          */
  U8                        _align3;                  /*< 65:  1> alignment                                          */
  U8                        _align4;                  /*< 66:  1> alignment                                          */
  U8                        v_add_acc_tech;           /*< 67:  1> valid-flag                                         */
  T_add_acc_tech            add_acc_tech;             /*< 68: 20> Additonal Access Technologies                      */
} T_ra_cap_values;
#endif
...
typedef struct
{
  T_ra_cap_values           ra_cap_values;            /*<  0: 88> Actual MS RA capability value part                 */
} T_ra_cap_r;
#endif
...
// ELEM-FF: REL99 
  T_ra_cap_values           ra_cap_values;            /*<  0: 88> Actual MS RA capability value part                 */
// ELEM-FF: REL99 
  U8                        _align0;                  /*< 88:  1> alignment                                          */
  U8                        _align1;                  /*< 89:  1> alignment                                          */
  U8                        v_ra_cap_r;               /*< 90:  1> valid-flag                                         */
  U8                        c_ra_cap_r;               /*< 91:  1> counter                                            */
  T_ra_cap_r                ra_cap_r[MAX_ADD_RA_CAP]; /*< 92:352> Recursive MS RA capability value part              */
// ELEM-FF: !REL99 
//   U8                        acc_tech_typ;             /*<  0:  0> Access Technology Type                             */
// ELEM-FF: !REL99 
//   T_acc_cap                 acc_cap;                  /*<  0:  0> Access capabilities                                */
// ELEM-FF: !REL99 
//   U8                        flag_ra_cap2;             /*<  0:  0> Valid flag for MS RA capability value part II; Second part of MS RA capability is available (1) or not (1) */
// ELEM-FF: !REL99 
//   U8                        v_ra_cap2;                /*<  0:  0> valid-flag                                         */
// //   T_ra_cap2                 ra_cap2;                  /*<  0:  0> RAC structure for R97                              */
} T_ra_cap;
#endif
...
{
  U8                        num_cells;                /*<  0:  1> Number of Cells                                    */
  U8                        c_ccn_support;            /*<  1:  1> counter                                            */
  U8                        ccn_support[BIT7_MAX];    /*<  2:128> CCN is supported towards the corresponding cell    */
...
typedef struct
{
  U8                        ext_dtm_g_ms_class;       /*<  0:  1> Extended DTM GPRS Multi Slot Sub-Class             */
  U8                        ext_dtm_e_ms_class;       /*<  1:  1> Extended DTM EGPRS Multi Slot Sub-Class            */
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
} T_ext_dtm_ms;
#endif
...
typedef struct
{
  ...
  U8                        umts_tdd_128;             /*< 68:  1> UMTS 1.28 Mcps TDD Radio Access Technology; MS does supports UMTS TDD (1) or not (0) */
  U8                        geran_feat_pack_1;        /*< 69:  1> Network Support for GERAN Feature 1 Package        */
  U8                        _align7;                  /*< 70:  1> alignment                                          */
  U8                        v_ext_dtm_ms;             /*< 71:  1> valid-flag                                         */
  T_ext_dtm_ms              ext_dtm_ms;               /*< 72:  4> Extended DTM Multislot Structure                   */
  U8                        v_high_ms_cap;            /*< 76:  1> valid-flag                                         */
  U8                        high_ms_cap;              /*< 77:  1> High Multislot Capability                          */
  U8                        v_geran_iu_mod_cap;       /*< 78:  1> valid-flag                                         */
  U8                        geran_iu_mod_cap;         /*< 79:  1> GERAN Iu Mode Capabilities                         */
  U8                        geran_feat_pack_2;        /*< 80:  1> GERAN Feature Package 2                            */
  U8                        gmsk_ms_pwr_prof;         /*< 81:  1> GMSK Multislot Power Profile                       */
  U8                        psk8_ms_pwr_prof;         /*< 82:  1> 8-PSK Multislot Power Profile                      */
  U8                        v_t_gsm400_struct;        /*< 83:  1> valid-flag                                         */
  T_t_gsm400_struct         t_gsm400_struct;          /*< 84:  4> GSM 400 Bands Supported Structure                  */
  U8                        v_t_gsm900_cap;           /*< 88:  1> valid-flag                                         */
  U8                        t_gsm900_cap;             /*< 89:  1> T-GSM 400 Associated Radio Capability              */
  U8                        dl_adv_rx_per;            /*< 90:  1> Downlink Advanced Receiver Performance             */
  U8                        dtm_enhance_cap;          /*< 91:  1> DTM Enhancements Capability                        */
  U8                        _align8;                  /*< 92:  1> alignment                                          */
  U8                        _align9;                  /*< 93:  1> alignment                                          */
  U8                        _align10;                 /*< 94:  1> alignment                                          */
  U8                        v_dtm_high_ms;            /*< 95:  1> valid-flag                                         */
  T_dtm_high_ms             dtm_high_ms;              /*< 96:  4> DTM High Multislot Structure                       */
  U8                        rep_acch_cap;             /*<100:  1> Indicates whether the MS supports Repeated SACCH and Repeated FACCH */
  U8                        _align11;                 /*<101:  1> alignment                                          */
  U8                        _align12;                 /*<102:  1> alignment                                          */
  U8                        _align13;                 /*<103:  1> alignment                                          */
} T_mob_class_3;
#endif
...
typedef struct
{
  U8                        tdd_indic0;               /*<  0:  1> TDD_Indic0                                         */
  U8                        c_tdd_ncell_data;         /*<  1:  1> counter                                            */
  U16                       tdd_ncell_data[MAX_TDD_CELLS]; /*<  2: 42> bits 1-7 are the Cell Parameter, bit 8 is the Sync Case and bit 9 is the Diversity bit.  */
} T_tdd_ci_struct;
#endif
...
typedef struct
{
  U8                        fdd_indic0;               /*<  0:  1> FDD_Indic0                                         */
  U8                        c_fdd_ncell_data;         /*<  1:  1> counter                                            */
  U16                       fdd_ncell_data[MAX_FDD_CELLS]; /*<  2: 34> bits 1-9 are the Scrambling Code and bit 10 is the corresponding Diversity Parameter */
} T_fdd_ci_struct;
#endif
...
typedef struct
{
  ...
  U16                       tdd_arfcn;                /*<  2:  2> TDD_ARFCN                                          */
  U8                        v_tdd_arfcn_index;        /*<  4:  1> valid-flag                                         */
  U8                        tdd_arfcn_index;          /*<  5:  1> TDD ARFCN index                                    */
  U8                        _align0;                  /*<  6:  1> alignment                                          */
  U8                        _align1;                  /*<  7:  1> alignment                                          */
  T_tdd_ci_struct           tdd_ci_struct;            /*<  8: 44> TDD Neighbour cell information                     */
} T_rep_u_tdd_cells;
#endif
...
typedef struct
{
  ...
  U16                       fdd_arfcn;                /*<  2:  2> FDD_ARFCN                                          */
  U8                        v_fdd_arfcn_index;        /*<  4:  1> valid-flag                                         */
  U8                        fdd_arfcn_index;          /*<  5:  1> FDD ARFCN index                                    */
  U8                        _align0;                  /*<  6:  1> alignment                                          */
  U8                        _align1;                  /*<  7:  1> alignment                                          */
  T_fdd_ci_struct           fdd_ci_struct;            /*<  8: 36> FDD Neighbour cell information                     */
} T_rep_u_fdd_cells;
#endif
...
typedef struct
{
  ...
  U8                        bw_tdd;                   /*<  1:  1> Bandwidth TDD                                      */
  U8                        v_rep_u_tdd_cells;        /*<  2:  1> valid-flag                                         */
  U8                        c_rep_u_tdd_cells;        /*<  3:  1> counter                                            */
  T_rep_u_tdd_cells         rep_u_tdd_cells[MAX_TDD]; /*<  4:6812> Repeated UTRAN TDD Neighbour cells                 */
} T_utran_tdd;
#endif
...
typedef struct
{
  ...
  U8                        bw_fdd;                   /*<  1:  1> Bandwidth FDD                                      */
  U8                        v_rep_u_fdd_cells;        /*<  2:  1> valid-flag                                         */
  U8                        c_rep_u_fdd_cells;        /*<  3:  1> counter                                            */
  T_rep_u_fdd_cells         rep_u_fdd_cells[MAX_FDD]; /*<  4:5764> Repeated UTRAN FDD Neighbour cells                 */
} T_utran_fdd;
#endif
...
typedef struct
{
  ...
  U8                        index_start_3g;           /*<  1:  1> Index Start 3G                                     */
  U8                        v_abs_index_emr;          /*<  2:  1> valid-flag                                         */
  U8                        abs_index_emr;            /*<  3:  1> Absolute Index start EMR                           */
  U8                        _align0;                  /*<  4:  1> alignment                                          */
  U8                        _align1;                  /*<  5:  1> alignment                                          */
  U8                        _align2;                  /*<  6:  1> alignment                                          */
  U8                        v_utran_fdd;              /*<  7:  1> valid-flag                                         */
  T_utran_fdd               utran_fdd;                /*<  8:5768> UTRAN FDD description                              */
  U8                        _align3;                  /*<5776:  1> alignment                                          */
  U8                        _align4;                  /*<5777:  1> alignment                                          */
  U8                        _align5;                  /*<5778:  1> alignment                                          */
  U8                        v_utran_tdd;              /*<5779:  1> valid-flag                                         */
  T_utran_tdd               utran_tdd;                /*<5780:6816> UTRAN TDD description                              */
} T_threeg_cells;
#endif
...
typedef struct
{
  T_cd2k_str_011            cd2k_str_011;             /*<  0:  4> Structured Element                                 */
  U8                        qof;                      /*<  4:  1> QOF                                                */
  U8                        walsh_len_c;              /*<  5:  1> WALSH_LEN_C                                        */
  U8                        aux_walsh_len;            /*<  6:  1> AUX_WALSH_LEN                                      */
  U8                        _align0;                  /*<  7:  1> alignment                                          */
  T_cd2k_str_110_1          cd2k_str_110_1;           /*<  8:  4> Structured Element                                 */
  T_cd2k_str_110_2          cd2k_str_110_2;           /*< 12:  4> Structured Element                                 */
} T_cd2k_str_110;
#endif
...
typedef struct
{
  ...
  U8                        _align0;                  /*<  1:  1> alignment                                          */
  U8                        _align1;                  /*<  2:  1> alignment                                          */
  U8                        v_cd2k_str_000;           /*<  3:  1> valid-flag                                         */
  T_cd2k_str_000            cd2k_str_000;             /*<  4:  4> Structured Element                                 */
  U8                        _align2;                  /*<  8:  1> alignment                                          */
  U8                        _align3;                  /*<  9:  1> alignment                                          */
  U8                        _align4;                  /*< 10:  1> alignment                                          */
  U8                        v_cd2k_str_001;           /*< 11:  1> valid-flag                                         */
  T_cd2k_str_001            cd2k_str_001;             /*< 12:  4> Structured Element                                 */
  U8                        _align5;                  /*< 16:  1> alignment                                          */
  U8                        _align6;                  /*< 17:  1> alignment                                          */
  U8                        _align7;                  /*< 18:  1> alignment                                          */
  U8                        v_cd2k_str_010;           /*< 19:  1> valid-flag                                         */
  T_cd2k_str_010            cd2k_str_010;             /*< 20:  8> Structured Element                                 */
  U8                        _align8;                  /*< 28:  1> alignment                                          */
  U8                        _align9;                  /*< 29:  1> alignment                                          */
  U8                        _align10;                 /*< 30:  1> alignment                                          */
  U8                        v_cd2k_str_011;           /*< 31:  1> valid-flag                                         */
  T_cd2k_str_011            cd2k_str_011;             /*< 32:  4> Structured Element                                 */
  U8                        _align11;                 /*< 36:  1> alignment                                          */
  U8                        _align12;                 /*< 37:  1> alignment                                          */
  U8                        _align13;                 /*< 38:  1> alignment                                          */
  U8                        v_cd2k_str_110;           /*< 39:  1> valid-flag                                         */
  T_cd2k_str_110            cd2k_str_110;             /*< 40: 16> Structured Element                                 */
} T_cd2k_str_all;
#endif
...
typedef struct
{
  ...
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        v_cd2k_str_all;           /*<  3:  1> valid-flag                                         */
  T_cd2k_str_all            cd2k_str_all;             /*<  4: 56> Structured Element                                 */
} T_cd2k_cell_str;
#endif
...
typedef struct
{
  ...
  U8                        _align1;                  /*<  5:  1> alignment                                          */
  U8                        _align2;                  /*<  6:  1> alignment                                          */
  U8                        c_cd2k_cell_str;          /*<  7:  1> counter                                            */
  T_cd2k_cell_str           cd2k_cell_str[MAX_CDMA2K_NEIGH_CELLS]; /*<  8:3840> Structured Element                                 */
...
typedef struct
{
  U8                        fdd_rep_offset;           /*<  0:  1> FDD Reporting Offset                               */
  U8                        fdd_rep_thres;            /*<  1:  1> FDD Reporting Threshold                            */
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
} T_fdd_report;
#endif
...
typedef struct
{
  U8                        tdd_rep_offset;           /*<  0:  1> TDD Reporting Offset                               */
  U8                        tdd_rep_thres;            /*<  1:  1> TDD Reporting Threshold                            */
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
} T_tdd_rep;
#endif
...
typedef struct
{
  U8                        cdma2000_rep_offset;      /*<  0:  1> CDMA2000 Reporting Offset                          */
  U8                        cdma2000_rep_thres;       /*<  1:  1> CDMA2000 Reporting Threshold                       */
  U8                        _align0;                  /*<  2:  1> alignment                                          */
  U8                        _align1;                  /*<  3:  1> alignment                                          */
} T_cdma2000_rep;
#endif
...
typedef struct
{
  ...
  U8                        _align0;                  /*<  1:  1> alignment                                          */
  U8                        _align1;                  /*<  2:  1> alignment                                          */
  U8                        v_egprs_pck_ch_req_bep_per; /*<  3:  1> valid-flag                                         */
  T_egprs_pck_ch_req_bep_per egprs_pck_ch_req_bep_per; /*<  4:  4> EGPRS packet channel and BEP period structure      */
  U8                        v_pfc_feature_mode;       /*<  8:  1> valid-flag                                         */
  U8                        pfc_feature_mode;         /*<  9:  1> PFC feature support by the N/W                     */
  U8                        v_dtm_support;            /*< 10:  1> valid-flag                                         */
  U8                        dtm_support;              /*< 11:  1> DTM support by the cell                            */
  U8                        v_bss_paging_coord;       /*< 12:  1> valid-flag                                         */
  U8                        bss_paging_coord;         /*< 13:  1> BSS paging co-ordination                           */
  U8                        v_ccn_active;             /*< 14:  1> valid-flag                                         */
  U8                        ccn_active;               /*< 15:  1> Indicates NACC support by rel 4 network            */
  U8                        v_nw_ext_ul_tbf;          /*< 16:  1> valid-flag                                         */
  U8                        nw_ext_ul_tbf;            /*< 17:  1> Indicates Extended UL TBF support by rel 4 network */
...
// ELEM-FF: REL99 
  ...
  U8                        _align1;                  /*<  2:  1> alignment                                          */
  U8                        _align2;                  /*<  3:  1> alignment                                          */
  T_gprs_ext_info           gprs_ext_info;            /*<  4: 20> BIT STRING: GPRS cell options Extension Information */
// ELEM-FF: !REL99 
//   U8                        ext_len;                  /*<  0:  0> Extension Length                                   */
// ELEM-FF: !REL99 
//   U8                        c_spare_ext;              /*<  0:  0> counter                                            */
// //   U8                        spare_ext[64];            /*<  0:  0> Spare bits(s)                                      */
} T_gprs_ext_bits;
#endif
...
typedef struct
{
  ...
  T_gprs_ext_bits           gprs_ext_bits;            /*< 16: 24> GPRS cell options extensions Bits IE               */
} T_gprs_cell_opt;
#endif
