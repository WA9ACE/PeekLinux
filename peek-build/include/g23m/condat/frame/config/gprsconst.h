...
#define  BTC_ADD_ENTITY_NUM 6 /*add by wupeng @ btc bj*/
#ifdef FF_BAT /* with GDD_DIO entity */
#if(PSP_STANDALONE==0)
#define MAX_ENTITIES                (39 + MAX_REMU_ENTITIES + BT_ADAPTER_ADD_ENTITIES +BTC_ADD_ENTITY_NUM)
#define MAX_OS_TASKS                (33 + MAX_REMU_OS_TASKS + BT_ADAPTER_ADD_OS_TASKS+BTC_ADD_ENTITY_NUM)
#else
#define MAX_ENTITIES                (2 + MAX_REMU_ENTITIES + 0+BTC_ADD_ENTITY_NUM)
#define MAX_OS_TASKS                (2 + MAX_REMU_OS_TASKS + 0+BTC_ADD_ENTITY_NUM)
#endif
#define MAX_SEMAPHORES              (14+ MAX_REMU_SEMAPHORES + BT_ADAPTER_ADD_SEMAPHORES+BTC_ADD_ENTITY_NUM)
#else
#if(PSP_STANDALONE==0)
#define MAX_ENTITIES                (38 + MAX_REMU_ENTITIES + BT_ADAPTER_ADD_ENTITIES+BTC_ADD_ENTITY_NUM)
#define MAX_OS_TASKS                (32 + MAX_REMU_OS_TASKS + BT_ADAPTER_ADD_OS_TASKS+BTC_ADD_ENTITY_NUM)
#else
#define MAX_ENTITIES                (2 + MAX_REMU_ENTITIES + 0+BTC_ADD_ENTITY_NUM)
#define MAX_OS_TASKS                (2 + MAX_REMU_OS_TASKS + 0+BTC_ADD_ENTITY_NUM)
#endif
#define MAX_SEMAPHORES              (13 + MAX_REMU_SEMAPHORES + BT_ADAPTER_ADD_SEMAPHORES+BTC_ADD_ENTITY_NUM)
#endif /* FF_BAT */
