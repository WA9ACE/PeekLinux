...
#include	"plus_specific/nucleus_specific.h"

#define         PLUS_1_11             1
#define         PLUS_1_13             2
#define         PLUS_1_14             3
#define         PLUS_1_15             4
#define         PLUS_VERSION_COMP     PLUS_1_15
...
#if ((!defined  _USER_TYPES_ ) && (!defined __TYPEDEFS_H__))
typedef char                CHAR;
#endif
...
/* Define what an interrupt vector looks like.  */
...
#if(defined(NU_PROFILE_PLUS))

#include "profile_agent/inc/profile_agent.h" 

#endif /* Nucleus PLUS Profiling Support */
