...
#define OS_MUTEX 			   T_RVF_MUTEX

//OMAPS72906 change to static_mutex
#define OS_INIT_MUTEX(mutex)   rvf_initialize_static_mutex(mutex)
#define OS_LOCK_MUTEX(mutex)   rvf_lock_mutex(mutex)
#define OS_UNLOCK_MUTEX(mutex) rvf_unlock_mutex(mutex)
#define OS_DELETE_MUTEX(mutex) rvf_delete_mutex(mutex)
