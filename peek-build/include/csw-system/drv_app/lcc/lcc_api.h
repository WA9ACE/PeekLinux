...
uint8 lcc_get_batt_level(void);
uint8 lcc_get_charging_state(void);
void lcc_disable_charge(void);
void lcc_enable_charge(void);
int lcc_set_gauge_interval(unsigned char sec);
#endif
