...
#define VCHG_BCI_THR   3600  //mV//
#define ICHG_BCI_THR   0x0A      //f0r 15.6mA ; for the settings :OFFEN =0;GAIN4=1;CLIB=0.
#define OVER_VOLTAGE  0x285 //the CHGVREG value curresponding to 4.2V
#define OVER_VOLTAGE_MV  4250  //Increase the over-charge threshold because the CV voltage provided by PMU may be a little higher than the standard 4.2V 


#define CV_CHARGE_START 4200
#define PWM_CHARGE_START 4100
#define PWM_CHARGE_STOP 4200
#define MONITOR_LEVEL 4200
#endif
#define LCC_TEMP_LOW  424// for temprerature protect, low temperature is -5, reg value is 0x1a8
#define LCC_TEMP_HIGH 29// for temprerature protect, high temperature is 60, reg value is 0x1d
#define LCC_TEMP_PRE_HIGH 58 // for temprerature protect, pre high temperature is 40, reg value is 0x3a
#endif
