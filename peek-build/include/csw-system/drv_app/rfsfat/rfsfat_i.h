...
#define RFSFAT_INVALID_MPT      0XFF    /* Invalid mount point Number */
...
typedef struct
{
 ...
 // FFS_SMALL_DIRECTORY_LABEL_STRUCT first_res; //first entry found
  ...
  UINT32                           lastSequentialClusterNmb;
  UINT32                           lastLogicalClusterNmb;
  UINT32                           baseClusterNmb;
